    ...
    return(
        <div className='catagory2-container'>
            ...
            <div className='catagory2-box'>
                <Link to={{ pathname : `/temp2_3_1`,}}>
                    <div className="promo2 promo-first" >
                        <div className="image-wrapper2">
                            <img src={catagory_img}/>
                        </div>
                        <h2 className="title2" >DooMilk</h2>
                    </div>
                </Link>
                <Link to={{ pathname : `/temp1_3_2`,}}>
                    <div className="promo2 promo-second" >
                        <div className="image-wrapper2">
                            <img src={catagory_img}/>
                        </div>
                        <h2 className="title2" >Diary Milk</h2>
                    </div>
                </Link>
                <Link to={{ pathname : `/temp2_3_3`,}}>
                ...
                <Link to={{ pathname : `/temp2_3_5`,}}>
                    <div className="promo2 promo-fifth" >
                        <div className="image-wrapper2">
                            <img src={catagory_img}/>
                        </div>
